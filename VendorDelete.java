...
public class VendorDelete extends JFrame implements ActionListener {
    JTextField t1, l11;
    JLabel l12;
    JButton b1, b2, b3;
    String id;
    ...
    VendorDelete() {
        ...
        JLabel title = new JLabel("DELETE VENDOR INFORMATION");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b3) {
            ...
            try {
                c.s.executeUpdate("delete from vendor where id = '" + id + "'");
